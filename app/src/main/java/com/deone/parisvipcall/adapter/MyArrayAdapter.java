...
public class MyArrayAdapter extends ArrayAdapter<LogInformation> {
    ...
    private List<LogInformation> modelList;
    Context context;
    ...
    private static class ViewHolder {
        ...
        private ViewHolder(RelativeLayout rootView, TextView tvLogin, TextView tvPassword, TextView tvTypeChoose) {
        ...
        public static ViewHolder create(RelativeLayout rootView) {
            ...
            return new ViewHolder(rootView, tvLogin, tvPassword, tvTypeChoose);
        }
    }
}
